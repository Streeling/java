...
----
+
ruleaza proiectul, apoi acceseaza http://localhost/ folosind navigatorul web, presupun ca intuiesti care mesaj trebui sa fie afisat?
...
import <Calea pana la clasa Customer>
...
----
+
ruleaza proiectul, apoi acceseaza http://localhost/customers folosind navigatorul web, ar trebui sa vezi reprezentarea JSON a obiectului `Customer` create in controler.
